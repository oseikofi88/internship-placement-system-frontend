...
@Component({
  selector: 'app-confidential-appraisal-forms',
  templateUrl: './confidential-appraisal-forms.component.html',
  styleUrls: ['./confidential-appraisal-forms.component.css']
})
export class ConfidentialAppraisalFormsComponent implements OnInit {
index_number: number;
...
year:any;
 ...
 html2canvas(document.getElementById('letter')).then(function(canvas) {
    ...
    doc.save('Internship Confidential Appraisal Form.pdf');
    });
  }
